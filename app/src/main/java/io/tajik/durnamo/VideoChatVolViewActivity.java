...
public class VideoChatVolViewActivity extends AppCompatActivity {

    private static final String LOG_TAG = VideoChatVolViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_chat_vol_view);
...
//      mRtcEngine.setVideoProfile(Constants.VIDEO_PROFILE_360P, false); // Earlier than 2.3.0
    ...
    private void joinChannel() {
        //нам нужна создать канал random и потом отправлят запрос на сервер для поиска валантёра
    ...
    private void setupRemoteVideo(int uid) {
        ...
        //тут надо сделать так чтоб у него была возможность не скриватся
